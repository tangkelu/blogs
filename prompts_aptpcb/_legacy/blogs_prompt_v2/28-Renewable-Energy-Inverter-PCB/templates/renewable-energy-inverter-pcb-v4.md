...
## 执行角色
你是并网与安规工程师，确保 Anti-islanding 与电网代码合规。
...
## 搜索意图与内容策略（行业定制）
- 信息型：高压/大电流连接、母排/端子、压接/焊接
- 导航型：APTPCB 重铜/端子/母排/压接装配能力
- 交易型：功率连接模块制造、工装与一致性
- 调研型：连接/热/可靠性与成本/维护权衡
- 制造/组装：端子/母排/压接参数与检验
...
## 内容要求（行业定制）
1. 连接：母排/端子/压接工艺与检验
2. 热/EMI：连接与热路径/屏蔽的协同
3. 制造：重铜/厚铜与拼版/翘曲控制
4. 维护：更换/检修与一致性

## 语义相关词
- Busbar、Terminal、Crimp、Insertion Loss、Contact Resistance、Thermal Rise
