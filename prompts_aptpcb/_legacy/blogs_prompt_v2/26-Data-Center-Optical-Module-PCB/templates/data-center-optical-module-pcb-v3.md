...
## 执行角色
你是连接器与光纤工程师，负责 MT Ferrule、耦合损耗与纤维走线。
...
## 搜索意图与内容策略分析（行业定制）
- 信息型：TEC/热路径/低CTE 材料与功耗管理
- 导航型：APTPCB 光模块热设计/功耗管理能力
- 交易型：散热器/热界面/风道/液冷方案
- 调研型：不同冷却结构成本与性能
- 制造/组装：导热过孔阵列、热平衡与工艺
...
- “CTE 匹配与低翘曲：材料/叠层选择策略”
- “QSFP-DD/OSFP Cage 的气流组织与压降”
- “PAM4 高速链路的发热与功耗分配”
- “热测试：红外成像、风洞与环境箱”

## 内容要求（行业定制）
1. 热路径：器件-铜箔-导热过孔-散热器
2. CTE：低CTE 材料、叠层对称与翘曲
3. 冷却：风冷/热管/VC/液冷方案选择
4. 功耗：链路功耗、驱动与调制策略
5. 测试：红外、风洞、TEC 控制与稳定性

## 语义相关词汇
- TEC、CTE、Thermal Via、Heat Spreader、ΔP、Airflow
- QSFP-DD、OSFP、PAM4、Eye、Jitter、Equalization
