...
## 执行角色
你是可靠性与合规工程师，确保 GR-468/IEC 等标准符合性。
...
## 搜索意图与内容策略分析（行业定制）
- 信息型：GR-468/IEC/可靠性应力与验证
- 导航型：APTPCB 可靠性平台与一致性能力
- 交易型：可靠性测试/整改/一致性报告
- 调研型：不同应力模型与寿命预测
- 制造/组装：材料/工艺对可靠性的影响
...
## H2 标题示例（行业定制）
- “GR-468 可靠性试验项目与判据解读”
- “温湿度/热循环/机械应力：对光模块的影响”
- “寿命模型：Arrhenius/德温/功率循环”
- “一致性失败的定位、纠正与再验证”
- “可追溯与批次一致性管理方法”

## 内容要求（行业定制）
1. 标准：GR-468/IEC 相关条款与判据
2. 应力：温湿度、热循环、振动冲击、腐蚀
3. 模型：Arrhenius/德温、功率循环与寿命
4. 制造：材料/工艺/装配对可靠性的影响
5. 报告：一致性测试、数据处理与整改

## 语义相关词汇
- GR-468、IEC、Arrhenius、Weibull、HALT/HASS、HAST
