...
## 执行角色
你是可穿戴系统工程师，研究柔性/刚柔板、超低泄漏功耗与安全充电。
...
## 搜索意图与内容策略分析（行业定制）
- 信息型：柔性/刚柔工艺、材料与耐久性
- 导航型：APTPCB 刚柔/超小封装贴装能力
- 交易型：FPC/刚柔样机、小批量与工艺验证
- 调研型：材料/工艺/成本的综合权衡
- 制造/组装：COF/COG/超细间距焊接与良率

## H2 标题示例（行业定制）
- “FPC 材料/铜箔/覆盖膜：弯折与耐久性”
- “刚柔过渡区：补强/过孔与机械可靠性”
- “超细间距与微小器件的贴装与检测”
- “封装形式：COF/COG/SiP 在可穿戴中的应用”
- “可靠性：跌落/汗液/温湿度/弯折寿命”

## 内容要求（行业定制）
1. 材料：PI、铜箔、覆盖膜与胶粘剂
2. 结构：刚柔过渡、补强板、过孔/走线
3. 贴装：01005/0201、微型连接器与检测
4. 可靠性：弯折寿命、汗液/温湿度、跌落
5. 认证：可穿戴/皮肤接触的生物相容

## 语义相关词汇
- FPC、Rigid-Flex、Reinforcement、COF/COG、Micro Connector
- Bending Radius、Bending Cycle、Biocompatibility
