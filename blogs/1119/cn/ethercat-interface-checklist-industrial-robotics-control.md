...
<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 8px; padding: 20px; margin: 20px 0;">
    <h3 style="color: white; text-align: center; border-bottom: 2px solid white; padding-bottom: 10px;">关键时序参数提醒</h3>
    <ul style="list-style-type: none; padding: 0;">
        <li style="margin-bottom: 10px;"><b>&#9989; Watchdog Timeout:</b> 必须大于最长的正常程序执行循环，但要足够短以快速响应程序挂起。</li>
        <li style="margin-bottom: 10px;"><b>&#9989; Test Pulse Width:</b> 必须足够短，以避免执行器误动作；但必须足够长，以便反馈电路可靠检测。</li>
        <li style="margin-bottom: 10px;"><b>&#9989; Cross-Monitoring Period:</b> 两个 MCU 间的通信周期必须远小于要求的故障反应时间。</li>
        <li style="margin-bottom: 10px;"><b>&#9989; Fault Reaction Time (FRT):</b> 整个安全链条的时间总和，是认证测试中的核心验证项。</li>
    </ul>
</div>
...
<div style="background: linear-gradient(135deg, #007991 0%, #78ffd6 100%); color: #1A237E; border-radius: 8px; padding: 20px; margin: 20px 0;">
    <h3 style="color: #1A237E; text-align: center; border-bottom: 2px solid #1A237E; padding-bottom: 10px;">HILPCB 组装优势</h3>
    <p style="text-align: center; font-size: 1.1em;">我们深知安全关键型 PCB 对组装质量的苛刻要求。HILPCB 提供：</p>
    <ul style="list-style-type: '✔ '; padding-left: 20px;">
        <li style="margin-bottom: 10px;"><b>精密焊接工艺：</b>无论是大尺寸的通孔安全继电器还是精密的 SMT 元件，我们都能通过严格的工艺控制确保焊接的可靠性与一致性。</li>
        <li style="margin-bottom: 10px;"><b>元器件采购与追溯：</b>我们从授权渠道采购所有元器件，确保其真实性和性能，并为安全关键部件提供完整的可追溯性。</li>
        <li style="margin-bottom: 10px;"><b>严格的 AOI 与 X-Ray 检测：</b>自动光学检测（AOI）和 X-Ray 检测能够发现潜在的焊接缺陷，为卓越的 `EtherCAT interface PCB quality` 提供保障。</li>
    </ul>
</div>
