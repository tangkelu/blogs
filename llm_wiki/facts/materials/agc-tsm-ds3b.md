---
fact_id: "materials-agc-tsm-ds3b"
title: "AGC TSM-DS3b low-loss microwave laminate material card"
topic: "TSM-DS3b"
category: "materials"
status: "verified"
confidence: "high"
...
source_ids: ["agc-tsm-ds3b-datasheet"]
tags: ["agc", "tsm-ds3b", "low-loss", "rf-materials", "microwave", "thermal-conductivity", "laminate"]
---

# Canonical Summary

> TSM-DS3b is an AGC low-loss microwave laminate variant with `10 GHz` Dk / Df rows and the same low-fiberglass / high-thermal-conductivity family positioning. Do not collapse it into TSM-DS3.

## Stable Facts

- AGC identifies TSM-DS3b as a dimensionally stable low-loss laminate and ceramic-filled reinforced material with low fiberglass content.
- AGC frames TSM-DS3b around couplers, phased-array antennas, radar manifolds, mmWave antenna / automotive, oil drilling, and semiconductor / ATE testing contexts.
- At `10 GHz`, the TDS lists dielectric constant `3.00 +/- 0.04` by `IPC-650 2.5.5.3`.
...
- Preserve the `10 GHz` condition on Dk / Df rows.
- Treat insertion-loss plots and resistor-foil-stability context as product context, not board-level proof.
...
- It does not prove insertion loss, registration yield, sequential-lamination success, resistor-foil performance, or supplier build capability.
