---
evidence_id: "pcbziliao-package-thermal-pad-or-flash-naming-grammar"
batch_id: "pcb_ziliao"
...
claim_summary: "Handbook text example for thermal-pad or flash naming grammar that is useful as local naming-inventory provenance only."
authority_class: "blocked_evidence"
allowed_use:
  - "local naming-inventory provenance for thermal-pad or flash grammar"
  - "future authority-recovery inventory for controlled library naming conventions"
blocked_use:
  - "universal flash naming rule"
  - "standards-grade thermal-pad naming grammar"
...
This preserved local text excerpt is safe only as thermal-pad or flash naming-grammar inventory.

## Allowed Use

- Preserve local provenance for future controlled library-naming recovery.
- Record that the handbook exposes tokenized flash naming examples.
