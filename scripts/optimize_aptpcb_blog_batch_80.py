...
POSTS: list[PostRef] = [
    PostRef("2025", "04", "dispatch-system-pcb"),
    PostRef("2025", "03", "chemical-sensor-pcb"),
    PostRef("2025", "02", "optical-sorting"),
    PostRef("2025", "01", "time-base-corrector"),
    PostRef("2025", "01", "central-station-pcb"),
    PostRef("2025", "01", "48v-vrm-board-guide"),
    PostRef("2025", "12", "single-layer-pcb-basics"),
    PostRef("2025", "12", "digital-transmitter-pcb"),
    PostRef("2025", "12", "debug-log-practice"),
    PostRef("2025", "09", "mobile-app-control"),
    PostRef("2025", "09", "cleanliness-testing-pcb"),
    PostRef("2025", "08", "studio-monitor-pcb"),
    PostRef("2025", "08", "automotive-iatf-linkage"),
    PostRef("2025", "06", "electrowetting-pcb"),
    PostRef("2025", "04", "printing-kiosk-pcb"),
    PostRef("2025", "04", "power-factor-meter"),
    PostRef("2025", "04", "pcb-stackup-design-2"),
    PostRef("2025", "03", "optical-module-pcb"),
    PostRef("2025", "12", "clarification-pcb"),
    PostRef("2025", "11", "thermal-cycling-stress"),
    PostRef("2025", "09", "stepper-drive-pcb"),
    PostRef("2025", "08", "grid-analyzer-pcb"),
    PostRef("2025", "06", "fiber-optic-sensor-pcb"),
    PostRef("2025", "05", "solder-paste-selection"),
    PostRef("2025", "05", "aoi-spi-best-practices"),
    PostRef("2025", "04", "best-pcb-manufacturers-2"),
    PostRef("2025", "03", "payment-kiosk-pcb"),
    PostRef("2025", "02", "burn-in-profiling"),
    PostRef("2025", "02", "8d-problem-solving"),
    PostRef("2025", "01", "ul-2849-compliance-pcb"),
    PostRef("2025", "12", "hurricane-monitor-pcb"),
    PostRef("2025", "04", "inference-server-pcb"),
    PostRef("2025", "12", "programmable-logic-controller"),
    PostRef("2025", "09", "antenna-tuning-and-trimming"),
    PostRef("2025", "07", "continuity-test-checklist"),
    PostRef("2025", "01", "microsection-coupon-strategy"),
    PostRef("2025", "01", "aircraft-entertainment-pcb"),
    PostRef("2025", "11", "radiation-monitor-pcb"),
    PostRef("2025", "04", "industrial-grade-pmbus-monitor-pcb"),
    PostRef("2025", "11", "manufacturing-and-assembly"),
    PostRef("2025", "11", "industrial-grade-cowos-carrier-substrate"),
    PostRef("2025", "06", "navigation-aid-pcb"),
    PostRef("2025", "05", "led-mcpcb-assembly-and-reflow"),
    PostRef("2025", "05", "innerlayer-registration-lesson"),
    PostRef("2025", "12", "rf-generator-pcb"),
    PostRef("2025", "12", "oscilloscope-pcb"),
    PostRef("2025", "12", "emi-analyzer-pcb"),
    PostRef("2025", "10", "marine-power"),
    PostRef("2025", "10", "church-audio"),
    PostRef("2025", "09", "bed-of-nails-tutorial"),
    PostRef("2025", "08", "root-cause-pareto-pcb"),
    PostRef("2025", "08", "calibration-generator-pcb"),
    PostRef("2025", "07", "off-grid-inverter-pcb"),
    PostRef("2025", "06", "shock-logger-pcb"),
    PostRef("2025", "06", "emi-mitigation-layout"),
    PostRef("2025", "04", "solar-camera"),
    PostRef("2025", "02", "touch-driver-pcb"),
    PostRef("2025", "12", "neonatal-monitor-pcb"),
    PostRef("2025", "11", "threat-detection-pcb"),
    PostRef("2025", "09", "on-board-charger-pcb"),
    PostRef("2025", "09", "anpr-camera-pcb"),
    PostRef("2025", "09", "agricultural-weather-pcb"),
    PostRef("2025", "07", "co-detector-pcb"),
    PostRef("2025", "03", "av-receiver-pcb"),
    PostRef("2025", "02", "xeon-server-pcb"),
    PostRef("2025", "01", "sequencing-batch-pcb"),
    PostRef("2025", "12", "pa-speaker-pcb"),
    PostRef("2025", "11", "ev-charger-pcb"),
    PostRef("2025", "09", "wind-shear-pcb"),
    PostRef("2025", "08", "workflow-system-pcb"),
    PostRef("2025", "05", "barcode-scanner-pcb"),
    PostRef("2025", "04", "flight-computer-pcb"),
    PostRef("2025", "04", "cob-led-display-pcb"),
    PostRef("2025", "04", "aoi-inspection-pcba"),
    PostRef("2025", "03", "mesh-light-pcb"),
    PostRef("2025", "12", "cable-car"),
    PostRef("2025", "11", "fast-turn-pcb-2"),
    PostRef("2025", "11", "blu-ray-player-pcb"),
    PostRef("2025", "09", "femtocell-pcb"),
    PostRef("2025", "08", "solar-analyzer-pcb"),
]
...
def _maybe_unwrap_fenced_frontmatter(text: str) -> str:
    # Some locale files were accidentally wrapped like:
    # ```markdown
    # ---
    # ...
    # ---
    ...
    t = text[len("```markdown\n") :]
    # Remove a closing fence line that appears immediately after the frontmatter block.
    t = re.sub(r"(\n---\n)\n?```\n", r"\1", t, count=1)
    return t
