...
POSTS: list[PostRef] = [
    PostRef("2025", "10", "data-center-chiplet-bridge-pcb"),
    PostRef("2025", "06", "high-speed-grid-code-compliance-interface"),
    PostRef("2025", "03", "automotive-grade-ethercat-interface-pcb"),
    PostRef("2025", "07", "encoder-interface-board-quality"),
    PostRef("2025", "06", "personal-air-quality-sensor-pcb"),
    PostRef("2025", "06", "ipc-class-2-vs-class-3-assembly"),
    PostRef("2025", "06", "hand-solder-best-practices"),
    PostRef("2025", "05", "vibration-stress-screening"),
    PostRef("2025", "04", "adhesive-creep-and-delamination"),
    PostRef("2025", "03", "ionic-contamination-limits"),
    PostRef("2025", "12", "cleanliness-ionics-basics"),
    PostRef("2025", "11", "ceramic-dbc-amb-copper-bonding"),
    PostRef("2025", "09", "redundant-psu-backplane-design"),
    PostRef("2025", "07", "double-layer-pcb-tutorial"),
    PostRef("2025", "07", "automotive-ethernet-pcb-layout"),
    PostRef("2025", "06", "blind-buried-via-planning"),
    PostRef("2025", "05", "hbm3-interposer-pcb-guide"),
    PostRef("2025", "04", "lidar-interface-board-assembly"),
    PostRef("2025", "02", "defect-classification-smt"),
    PostRef("2025", "01", "potting-material-selection-bms"),
    PostRef("2025", "12", "hair-steam-cap-controller-pcb"),
    PostRef("2025", "10", "soldering-on-ceramic"),
    PostRef("2025", "09", "selective-solder-palette"),
    PostRef("2025", "09", "rigid-flex-pcb-stackup-design"),
    PostRef("2025", "08", "optical-interconnect-pcb"),
    PostRef("2025", "05", "rdl-fan-out-substrate-routing"),
    PostRef("2025", "04", "stencil-design-for-0201-01005"),
    PostRef("2025", "02", "yield-analytics-workflow"),
    PostRef("2025", "02", "ethercat-interface-pcb-design"),
    PostRef("2025", "02", "clinical-information-pcb"),
    PostRef("2025", "02", "cleaning-after-soldering"),
    PostRef("2025", "01", "vulnerability-assessment-pcb"),
    PostRef("2025", "11", "pick-and-place-tutorial"),
    PostRef("2025", "10", "software-validation-pcb"),
    PostRef("2025", "10", "anaerobic-digestion-pcb"),
    PostRef("2025", "09", "overmolding-for-rf-front-end"),
    PostRef("2025", "08", "reflow-profile-basics-soak-time-peak-and-delta-t"),
    PostRef("2025", "08", "adhesiveless-copper-fpc"),
    PostRef("2025", "05", "fpc-laser-drilling-microvias"),
    PostRef("2025", "04", "ul-flammability-for-fpc"),
]
