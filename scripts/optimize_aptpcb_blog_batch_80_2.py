...
POSTS: list[PostRef] = [
    PostRef("2025", "08", "sample-storage-pcb"),
    PostRef("2025", "08", "current-sensor-pcb"),
    PostRef("2025", "05", "railway-signal-pcb"),
    PostRef("2025", "05", "ai-development-pcb"),
    PostRef("2025", "03", "fire-control-radar"),
    PostRef("2025", "02", "emib-interconnect-board-impedance-control"),
    PostRef("2025", "02", "ccs-combo-pcb"),
    PostRef("2025", "11", "dc-power-analyzer"),
    PostRef("2025", "10", "led-projector-pcb"),
    PostRef("2025", "10", "high-potting-soak"),
    PostRef("2025", "09", "man-down-pcb"),
    PostRef("2025", "08", "ldmos-pa-pcb"),
    PostRef("2025", "07", "gate-operator-pcb"),
    PostRef("2025", "06", "real-time-pcr-pcb"),
    PostRef("2025", "05", "traffic-light-pcb"),
    PostRef("2025", "04", "power-monitor-pcb"),
    PostRef("2025", "03", "prepaid-meter-pcb"),
    PostRef("2025", "02", "fetal-monitor-pcb"),
    PostRef("2025", "03", "wireless-plc-pcb"),
    PostRef("2025", "01", "video-scaler-pcb"),
    PostRef("2025", "01", "lane-control-pcb"),
    PostRef("2025", "10", "xray-inspection"),
    PostRef("2025", "09", "epyc-server-pcb"),
    PostRef("2025", "04", "upconverter-pcb"),
    PostRef("2025", "02", "reflow-and-thermal-profile-for-ceramic"),
    PostRef("2025", "01", "strike-lock-pcb"),
    PostRef("2025", "10", "scale-pcb"),
    PostRef("2025", "06", "5g-sa-pcb"),
    PostRef("2025", "07", "eccm-pcb"),
    PostRef("2025", "05", "roku-pcb"),
    PostRef("2025", "02", "ai-native-pcb"),
    PostRef("2025", "10", "stl-link-pcb"),
    PostRef("2025", "10", "5g-balun-pcb"),
    PostRef("2025", "01", "hpa-pcb"),
    PostRef("2025", "04", "mini-pc-pcb"),
    PostRef("2025", "09", "high-mass-board-thermal-profiling"),
    PostRef("2025", "08", "isolated-power-and-communication"),
    PostRef("2025", "01", "pcb-prototype-vs-mass-production"),
    PostRef("2025", "01", "5g-du-pcb"),
    PostRef("2025", "12", "brain-training-pcb"),
    PostRef("2025", "10", "flex-emi-shielding-and-grounding"),
    PostRef("2025", "08", "wire-bonding-on-ceramic"),
    PostRef("2025", "08", "thermal-cycling-test-for-pcb-reliability"),
    PostRef("2025", "07", "healthcare-light-pcb"),
    PostRef("2025", "03", "high-speed-ecg-acquisition-board"),
    PostRef("2025", "10", "pcie-gen6-si-checklist-mass-production"),
    PostRef("2025", "08", "security-protocol-pcb"),
    PostRef("2025", "06", "esd-handling-guide"),
    PostRef("2025", "05", "dft-checklist-for-pcb-testability"),
    PostRef("2025", "04", "neurofeedback-pcb"),
    PostRef("2025", "04", "foldable-oled-pcb"),
    PostRef("2025", "10", "transparent-oled-pcb"),
    PostRef("2025", "07", "pcb-design-for-manufacturing-2"),
    PostRef("2025", "06", "water-treatment"),
    PostRef("2025", "04", "fft-analyzer-pcb"),
    PostRef("2025", "03", "playout-server"),
    PostRef("2025", "12", "assembly-solutions"),
    PostRef("2025", "10", "software-defined-radio"),
    PostRef("2025", "07", "depanelization-of-mcpcb"),
    PostRef("2025", "06", "thermal-interface-material-selection"),
    PostRef("2025", "04", "spi-inspection-tutorial"),
    PostRef("2025", "04", "hbm3-interposer-pcb-cost-optimization"),
    PostRef("2025", "01", "heat-pump-pool-heater-pcb"),
    PostRef("2025", "11", "void-control-for-vippo-bga"),
    PostRef("2025", "11", "thermal-imaging-pcb"),
    PostRef("2025", "07", "sic-inverter-gate-driver-pcb-best-practices"),
    PostRef("2025", "05", "cleanroom-manufacturing-for-medical"),
    PostRef("2025", "04", "software-defined-radar"),
    PostRef("2025", "02", "o-ran-ru-pcb-guide"),
    PostRef("2025", "02", "digital-radiography-pcb"),
    PostRef("2025", "01", "ble-medical-gateway-mass-production"),
    PostRef("2025", "09", "bms-balancing-board-design"),
    PostRef("2025", "08", "eye-generator-pcb"),
    PostRef("2025", "07", "mixed-assembly-planning"),
    PostRef("2025", "06", "gantry-control-pcb"),
    PostRef("2025", "05", "ict-fixture-introduction"),
    PostRef("2025", "05", "hdi-pcb-cost"),
    PostRef("2025", "03", "rf-front-end-low-noise-pcb-compliance"),
    PostRef("2025", "01", "via-plating-squeeze"),
    PostRef("2025", "12", "warpage-control-during-assembly"),
]
